...
class account // declaring class and its content as public and private as access
              // specifiers.
{
  int acno;
...
void account::create_account() // create account statements
{
  ...
  cout << "\n\nEnter The Name of The account Holder : "; // cout statement for
                                                         // name
  ...
  cout << "\nEnter The Initial amount (Deposit To our Attendant) : "; // initial
                                                                      // amount

  cin >> deposit;

  cout << "\nWith FatCat Bank, you now have an account for personnal use.\n";

  cout << "\nThe cats in The FatCat Bank thank you for chosing them meow!";
...
void account::modify() // statements of cin,cout for modify account like
                       // acno,accholdername,type,balance
{
  cout << "\nAccount No. : " << acno;
...
void account::report() const // report
{
  ...
  cout << acno << setw(10) << " " << name << setw(10) << " " << type << setw(6)
       << deposit << endl; // manipulator used setw
}
...
void deposit_withdraw(
    int, int); // declaring deposit_withdraw for depositing and withdrawing
...
int main() {
  ...
  intro();
  do {
    cout << "\n\n\n\tMAIN MENU"; // the following things are the things present
                                 // in the main menu
    ...
    case '9':
      ...
      break;
    case '0':
      cout << "\n\n\tThanks for using The FatCat Bank managemnt system <3";
      break;
    default:
      cout << "\a";
    }
  ...
  } while (ch != '0'); // exit the program when selected 0
  return 0;
}
...
void write_account() // to open new account
{
  ...
  outFile.open("account.dat",
               ios::binary |
                   ios::app); // ios::app to perform at the end of the file
...
void display_sp(int n) {
  ...
  inFile.open("account.dat",
              ios::binary); // ios::app to perform at the end of the file
...
void delete_account(int n) {
  ...
  cout << "\n\n\t Submit CHEQUE BOOK and all other documents with identity "
          "proof";
}
...
void intro() {
  ...
  cout << "\n\n\n\t Catsucci Corporation";

  cout << "\n\n\t WELCOMES YOU TO THE FATCAT";

  cout << "\n\n\t BANK MANAGEMENT SOFTWARE";

  cout << "\n\n\n\n DEVELOPED BY ";

  cout << "\n\n\n                -Iliass 'Catsucci' EL AISSAOUI";
